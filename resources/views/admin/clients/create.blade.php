                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="company_name" class="form-control" placeholder="Company Name"  value="{{ old('company_name') }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="gst_number" class="form-control" placeholder="GST Number"  value="{{ old('gst_number') }}" />
