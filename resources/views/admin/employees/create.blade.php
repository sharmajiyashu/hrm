                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <input type="radio"  name="gender" value="male" {{ (old('gender') == 'male') ? 'checked' : '' }} {{ (empty(old('gender')) ? 'checked' : '') }} > <span>Male</span>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="radio"  name="gender" value="female" {{ (old('gender') == 'female') ? 'checked' : '' }}  > <span>Female</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="date" id="first-name-column" name="date_of_birth" class="form-control" placeholder="Date of birth"  value="{{ old('date_of_birth') }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="date" id="first-name-column" name="date_of_join" class="form-control" placeholder="Date of join"  value="{{ old('date_of_join') }}" />
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <select name="designation" id="designation" class="select2 form-select">
                                                        ...
                                                        @foreach (config('constant.designation') as $key => $val)
                                                            <option value="{{ $key }}" {{ (old('designation') == $key) ? 'selected' : '' }}>{{ $val }}</option>    
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" name="salary" class="form-control" placeholder="Salary"  value="{{ old('salary') }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="date" id="first-name-column" name="probation_end_date" class="form-control" placeholder="Probation End Date"  value="{{ old('probation_end_date') }}" />
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <select name="state" id="department" class="select2 form-select">
                                                        ...
                                                        @foreach (config('states') as  $key => $val)
                                                            <option value="{{ $key }}" {{ (old('state') == $key) ? 'selected' : '' }}>{{ $key }}</option>    
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-3 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="city" class="form-control" placeholder="City"  value="{{ old('city') }}" />
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea name="address" class="form-control" id="" cols="4" rows="4" placeholder="Address">{{ old('address') }}</textarea>
